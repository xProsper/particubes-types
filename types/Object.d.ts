...
*/
const AddChild = (child: Object, child: Object, keepWorld: boolean) => 
/**
...
*/
const RemoveChild = (child: Object) => 
/**
...
*/
const SetParent = (parent: Object, parent: Object, keepWorld: boolean) => 
/**
...
*/
const RotateLocal = (angles: Number3, axis: Number3, angle: number) => 
/**
Object:RotateWorld(number3) -- euler angles
Object:RotateWorld(number3, number) -- axis angle

*/
const RotateWorld = (angles: Number3, axis: Number3, angle: number) => 
/**
...
*/
const TextBubble = (text: string, text: string, duration: number, text: string, duration: number, offset: number, text: string, duration: number, offset: number, color: Color, text: string, duration: number, offset: number, color: Color, bgColor: Color, text: string, duration: number, offset: number, color: Color, bgColor: Color, tail: boolean) => 
/**
...
*/
const ApplyForce = (self: Object, value: Number3) => 
/**
Instantaneously remove any ongoing text bubble.

*/
const ClearTextBubble = (self: Object) => 
}